...
| BIA Samples | [<img src="https://www.google.com/s2/favicons?sz=256&domain_url=https://uk1s3.embassy.ebi.ac.uk/bia-integrator-data/pages/omengff.html" alt="BIA Samples logo" width="30" height="30">](https://uk1s3.embassy.ebi.ac.uk/bia-integrator-data/pages/omengff.html) | Sample OME-Zarr datasets from the BioImage Archive for testing |
...
| OME 2024 NGFF challenge | [<img src="https://www.google.com/s2/favicons?sz=256&domain_url=https://ome.github.io/" alt="OME 2024 NGFF challenge logo" width="30" height="30">](https://ome.github.io/) | Close to 500 TB of data in the OME-Zarr 0.5 format |
...
| JAX OMERO | [<img src="https://www.google.com/s2/favicons?sz=256&domain_url=https://images.jax.org/webclient/userdata/?experimenter=-1" alt="JAX OMERO logo" width="30" height="30">](https://images.jax.org/webclient/userdata/?experimenter=-1) | The Jackson Laboratory public OMERO instance, links to OME-Zarr files are available in the key-value |
...
| VoDaSuRe | [<img src="https://www.google.com/s2/favicons?sz=256&domain_url=https://augusthoeg.github.io/VoDaSuRe/" alt="VoDaSuRe logo" width="30" height="30">](https://augusthoeg.github.io/VoDaSuRe/) | A large-scale dataset covering volumetric super-resolution data with micro-CT ([arXiv](https://arxiv.org/abs/2603.23153); [dataset](https://huggingface.co/datasets/AugustHoeg/VoDaSuRe)) |
