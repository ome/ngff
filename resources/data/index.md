...
These are datasets available in OME-Zarr format, hosted in various locations. They are representative of different types of scientific stories enabled by OME-Zarr.
|Resource                                                                 | Description
| ------------------------------------------------------------------------ | ---------------------------------------------------|
