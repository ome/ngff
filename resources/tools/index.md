...
| nifti-zarr-py | <a href="https://github.com/neuroscales/nifti-zarr"><img src="https://avatars.githubusercontent.com/u/155756215" alt="NIfTI-Zarr logo" width="30" height="30"> | A Python implementation of the [nifti-zarr](https://github.com/neuroscales/nifti-zarr) specification, converting between NIfTI and NIfTI-Zarr (an OME-Zarr format carrying NIfTI metadata) and reading NIfTI-Zarr directly. |
