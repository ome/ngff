...
| nifti-zarr-py | [![image](https://avatars.githubusercontent.com/u/155756215?s=60)](https://github.com/neuroscales/nifti-zarr-py) | A Python implementation of the [nifti-zarr](https://github.com/neuroscales/nifti-zarr) specification, converting between NIfTI and NIfTI-Zarr (an OME-Zarr format carrying NIfTI metadata) and reading NIfTI-Zarr directly. |
