...
| -------- | ------- | ------- |
| 3D Slicer (SlicerOMEZarr) | [<img src="https://www.google.com/s2/favicons?sz=256&domain_url=https://www.slicer.org" alt="3D Slicer logo" width="30" height="30">](https://github.com/fideus-labs/SlicerOMEZarr) | SlicerOMEZarr is a [3D Slicer](https://www.slicer.org/) extension for loading and saving local or remote OME-Zarr images, labels and time series, built on [ngff-zarr](https://github.com/fideus-labs/ngff-zarr) |
